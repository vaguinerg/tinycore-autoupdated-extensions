...
tce-load -lwi libvulkan-dev libva22-dev giflib7-dev v4l2-utils fontconfig-dev gettext-dev freetype-dev git ffmpeg7-dev openal-dev libpulseaudio pulseaudio-dev alsa-dev autoconf perl5 Xorg-7.7-3d-dev submitqc pulseaudio-dev unixODBC-dev bash compiletc gnutls38-dev alsa-dev krb5-dev openssl-dev libpcap-dev sdl2-dev opencl-headers pcsc-lite-dev libusb-dev sane-dev libgphoto2-dev gstreamer-dev weston-dev sstrip squashfs-tools binutils coreutils python3.9 python3.9-pip clang
